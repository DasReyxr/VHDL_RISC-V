...
--    signal S_P1OUT: std_logic_vector (7 downto 0) :="00000000";
    ...
    constant VROMIN : MEMORY := (
        ...
        x"45", x"50", x"45", x"50", -- Data values for addresses 4 to 7
        x"46", x"50", x"46", x"50", -- Data values for addresses 8 to 11
        x"46", x"50", x"46", x"50"  -- Data values for addresses 12 to 15
    );
    */
...
begin
--VELOCIDAD<='0'& C(23 downto 0) when B1UP ='1' else  C(24 downto 1) & '0' when B2DOWN='1' else VELOCIDAD;
    VALOR<= VALOR + 1 when B1UP = '1' and VALOR < 25 else 
            VALOR - 1 when B2DOWN = '1' and VALOR > 0 else VALOR;
    --Debugging --
    RESET<=RESETV;
    ----- 1 Second Counter ----- 
    -- Memoria --
