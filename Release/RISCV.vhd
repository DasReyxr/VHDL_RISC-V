...
begin
    ...
    */
    ...
    F_ZERO <='0' when ROMIN = x"4C"  else 
             '1' when INA = "000000000" or CPC = "000000000" or ROMIN = x"4B" else  
             '0';
    ...
    -- Decoder --
    PCL <= '1'  when (IBI="11") else '0';


    EN_AC <='1' when ((IBI="00" and (ROMIN = x"4F" or ROMIN<x"10" or (ROMIN>x"17" and ROMIN<x"38") or (ROMIN>x"3F" and ROMIN<x"47") or ROMIN=x"50" or ROMIN=x"51" or ROMIN=x"53")) or IBI="10")  else '0';    VALOR<= VALORA + 1 when B1UP = '0' and VALORA < 25 else VALORA - 1 when B2DOWN = '0' and VALORA > 0 else VALORA;
    ...
    SELR <= '0'&'0'&'0'&'0'&'0' & ROMIN(2 downto 0) when ROMIN(7 downto 3) < "01000" and IBI = "00" else "00000000";
    SELL <= 
